...
const App = () => {
  ...
  useEffect(() => {
    ...
    searchMovies("Tom and Jerry",extraMovies); // Initial search for Batman movies
  ...
  const searchMovies = async (title) => {
    ...
    const allMovies = data.Search.concat(extraMovies);

    setMovies(allMovies);  // Updating the movies state with the search results
  };
  const extraMovies = [
    { Title: "Barbie", Year: "2004", imdbID: "tt1856101" },
    { Title: "Blade Runner 2049", Year: "2017", imdbID: "tt0426955" },
    { Title: "Shinchan", Year: "1992", imdbID: "tt12853970" },
  ...
  return (
    <div className="app"> {/* Main container */}
      <h1>𝑴𝒐𝒗𝒊𝒆...✨❤️</h1> {/* Heading of the application */}
      ...
      <div className="search"> {/* Search input container */}
        <input
          ...
          placeholder="Search the movies" // Placeholder text for the input field
        />
